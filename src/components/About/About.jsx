      ...
      <section className="s-about" id="s-about">
        <div className="container">
          <div className="text">
            <h2>Sobre mim:</h2>
            <p>
              Olá, meu nome é Carlos Augusto Prado, tenho 31 anos, sou
              brasileiro de uma pequena cidade no Sul de Minas Gerais. Sou
              desenvolvedor front-end e desenvolvedor full-stack com foco em
              ReactJS e NodeJS. Estudo e atuo no mercado desde 2020 e já fiz
              inúmeros cursos para aprimorar minhas habilidades e conhecimentos.
